...
import 'package:learn_link/MainViews/OnBoardingPage.dart';
...
import 'login/registrazione_insegnante.dart';
import 'login/registrazione_studente.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      '/registrazione_studente': (context) => const RegistrazioneStudente(),
